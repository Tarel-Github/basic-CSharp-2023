...
namespace wf14_winforms_thread
{
    public partial class FrmMain : Form
    {
        ...
        private void Worker_DoWork(object sender, DoWorkEventArgs e)    // sender는 이벤트를 보내주는 대상
        {
        ...
        {
            // arg는 0~91사이 91보다 크면 오버플로가 발샹
            if (arg < 0 || arg > 91)
            {
                throw new Exception("오류ㅡ 0~91사이 입력");
            };
